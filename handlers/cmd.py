    ...
    await message.answer(
        emoji.emojize(
            ":gear:") + f' Это только первая версия (V.1.0), в дальнейшем проект будет улучшаться, и функционал будет расширяться.\n'
                     ...
                     f'· Андрей Тощаков - создатель этого проекта, основной разработчик\n'
                     f'· Шагбанов Ахмед - основной разработчик\n'
...
async def cmd_help(message: types.Message, state: FSMContext):
    ...
    await message.answer("Основные команды:"
                         ...
                         "этой функции, программа починится</b>" + emoji.emojize(":stop_sign:") +

                         "\n\n <b>2)</b> /math - Задачи по математике. В данном алгоритме вы выбираете категорию задания,"
                         " а потом просто проходите и нарешиваете соответствующие задания" + emoji.emojize(":book:") +

                         "\n\n <b>3)</b> /logic - Задачи на логику. Тоже самое что и задачи по математике, только другие"
                         " категории заданий" + emoji.emojize(":book:") +

                         "\n\n <b>4)</b> /flashcard - Пользовательские карточки. Флеш-карточки - это удобный способ "
                         "запоминания и повторения изучаемого материала. На одной стороне карточки пишется слово, "
                         "фраза или термин, а на другой - перевод или значение." + emoji.emojize(":label:") +

                         "\n\n <b>5)</b> /timer - Таймер. Вы можете поставить время выполнения определённых заданий. "
                         "Например: вы хотите, чтобы в 08:30 утра, вы стабильно тренировали карточки, тогда вам необходимо сделать следующие действия:\n"
                         "Прописать /timer --> нажать на 'Создать таймер' --> Ввести нужное время --> Всё, готово, таймер создан! " + emoji.emojize(":clock1:"),
                         reply_markup=types.ReplyKeyboardRemove())

    await message.answer('Второстепенные команды:'
                         '\n <b>1)</b> /start - Покажет начальное сообщение бота'
